  ...
  return (
    <div className="min-h-screen bg-mainBg text-fontWhite flex flex-col justify-center">
      <div className="flex justify-center items-center flex-wrap p-8">
        {/* 기능 1 */}
        <div className="bg-headerFooter p-6 m-4 w-full md:w-1/4 rounded-lg shadow-lg min-h-[34rem] flex flex-col justify-evenly">
          <img
            src={SI1}
            alt="기능 1 이미지"
        ...
        <div className="bg-headerFooter p-6 m-4 w-full md:w-1/4 rounded-lg shadow-lg min-h-[34rem] flex flex-col justify-evenly">
          ...
          <p className="font-batang text-content leading-relaxed mb-4">
            {func.func_contents2}
          </p>
          <img
            src={SI2}
