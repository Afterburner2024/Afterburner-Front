  ...
  return (
    <div className="min-h-screen bg-mainBg text-fontWhite flex flex-col justify-center">
      <div className="flex justify-center items-center flex-wrap p-8">
        {/* 기능 1 */}
        <div
          className="bg-headerFooter p-6 m-4 w-full md:w-1/4 rounded-lg shadow-lg min-h-[34rem] flex flex-col 
        justify-evenly animate__animated animate__fadeInUp animate-delay"
        >
          <img
            src={SI1}
            alt="기능 1 이미지"
          ...
          <p className="font-batang text-content-sm leading-normal">
            {func.func_contents1}
          </p>
        </div>
        ...
        <div
          className="bg-headerFooter p-6 m-4 w-full md:w-1/4 rounded-lg shadow-lg min-h-[34rem] flex flex-col 
        justify-evenly animate__animated animate__fadeInUp animate-delay2"
        >
          <h3 className="font-title text-md-title mb-4">{func.func_title2}</h3>
          <p className="font-batang text-content-sm leading-normal mb-4">
            {func.func_contents2}
          </p>
          <img
            src={SI2}
        ...
        <div
          className="bg-headerFooter p-6 m-4 w-full md:w-1/4 rounded-lg shadow-lg min-h-[34rem] flex flex-col 
        justify-evenly animate__animated animate__fadeInUp animate-delay3"
        >
          <img
            src={SI3}
            alt="기능 3 이미지"
